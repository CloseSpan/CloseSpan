      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "To request access, correction, or deletion, email shanmukhsain@gmail.com. Requests may require identity and workspace-authority verification. Provider credentials and source records may also need to be removed in the connected provider or Pipedream account.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "This policy may change as the product, providers, and legal requirements change. The effective date will be updated when material changes are published. Privacy questions and requests can be sent to shanmukhsain@gmail.com.",
          ],
        },
      ]}
      facts={[
      ...
      relatedLinks={[
        {
          ...
          href: "mailto:shanmukhsain@gmail.com?subject=CloseSpan%20privacy%20request",
        },
