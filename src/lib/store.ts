...
export function getState(orgId: string): DemoState {
...
export function approveAction(orgId: string, context: ActionContext): DemoState {
...
export function rejectAction(orgId: string, context: ActionContext): DemoState {
  const state = getState(orgId);
...
export function advanceLifecycle(orgId: string, context: ActionContext): DemoState {
  const state = getState(orgId);
...
export function approveNotifications(orgId: string, context: ActionContext): DemoState {
  const state = getState(orgId);
...
export function resetDemoState(): void { globalStore.feedbackFlowStates = new Map(); }
