/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a3acd068fa1dabcae81ae4f7a137405e)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	STATUS_EMAIL: SendEmail;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	STATUS_PUBLIC_ORIGIN: "https://uptime.closespan.com";
	STATUS_EMAIL_FROM: "status@closespan.com";
	STATUS_EMAIL_TO: "support@closespan.com";
	WEBSITE_URL: "https://www.closespan.com/";
	APPLICATION_URL: "https://www.closespan.com/login";
	API_HEALTH_URL: "https://www.closespan.com/api/health";
	COMPONENT_HEALTH_URL: "https://www.closespan.com/api/health/components";
	AGENT_EXECUTOR_URL: "https://closespan-agent-executor.shanmukhsain.workers.dev";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "STATUS_PUBLIC_ORIGIN" | "STATUS_EMAIL_FROM" | "STATUS_EMAIL_TO" | "WEBSITE_URL" | "APPLICATION_URL" | "API_HEALTH_URL" | "COMPONENT_HEALTH_URL" | "AGENT_EXECUTOR_URL">> {}
}
