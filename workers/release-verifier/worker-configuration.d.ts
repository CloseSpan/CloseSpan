/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6046569874a4c88f9ca25beda6669b10)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 nodejs_compat
interface __BaseEnv_Env {
	RELEASE_VERIFICATIONS: Queue;
	RELEASE_VERIFIER_SHARED_SECRET: string;
	RELEASE_VERIFIER_EXECUTOR_URL: string;
	RELEASE_VERIFIER_EXECUTOR_SHARED_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RELEASE_VERIFIER_SHARED_SECRET" | "RELEASE_VERIFIER_EXECUTOR_URL" | "RELEASE_VERIFIER_EXECUTOR_SHARED_SECRET" | "STATUS_PROBE_SECRET">> {}
}
