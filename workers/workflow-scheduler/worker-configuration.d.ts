/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/workflow-scheduler/wrangler.jsonc workers/workflow-scheduler/worker-configuration.d.ts` (hash: dd60dff5dfbc054c9b5df313478efc05)
